...
public class FateScriptEntrypointImpl extends ASTWrapperPsiElement implements FateScriptEntrypoint {

  public FateScriptEntrypointImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public FateScriptLabelRef getLabelRef() {
    return findNotNullChildByClass(FateScriptLabelRef.class);
  }
